...
export const tickets = [
  {
    kind: "thanks",
    serial: "A · 01",
    overline: "from your shelf, to mine",
    title: "dead poets society",
    photo: `${C}/dead-poets.png`,
    note: "thanks for telling me to watch this one. carpe diem hits different at 1am.",
  ...
  },
  {
    kind: "thanks",
    serial: "B · 02",
    overline: "from your queue, to mine",
    title: "moriarty the patriot",
    photo: `${C}/moriarty.jpg`,
    note: "and this one too. didn't know an anime could feel like a victorian poem until you sent it. the professor lives in my head rent free now. thanks for that.",
  ...
  },
  {
    kind: "note",
    serial: "D · 04",
    overline: "a small note to",
    title: "the gyumri barbar",
    photo: `${C}/gyumri.jpg`,
    note: "ok i just gotta say it. i love the way you talk. the gyumri բարբառ. keep using it, keep teaching me. (yeah, i don't really know how to translate that word properly. kinda the whole point tbh.)",
  ...
  },
  {
    ...
    note: "yk you mentioned you take notes from hannibal, so i'm putting your doppelgängers here instead of your actual pics. for the safety of all parties involved.",
    notePost: "😭",
